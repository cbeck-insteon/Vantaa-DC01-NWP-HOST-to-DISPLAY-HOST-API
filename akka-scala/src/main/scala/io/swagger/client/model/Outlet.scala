...
case class Outlet (
  ...
  topLevel: Option[OutletEnums.TopLevel] = None,
  bottomLevel: Option[OutletEnums.BottomLevel] = None
) extends ApiModel

object OutletEnums {

  type TopLevel = TopLevel.Value
  type BottomLevel = BottomLevel.Value
  object TopLevel extends Enumeration {
    val On = Value("on")
    val Off = Value("off")
  }

  object BottomLevel extends Enumeration {
    val On = Value("on")
    val Off = Value("off")
  }
